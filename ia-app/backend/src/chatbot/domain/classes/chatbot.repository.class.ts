...
export abstract class ChatbotRepository {
  ...
  public abstract getConversationWithMessages(conversationCode: string): Promise<ConversationEntity>;
  public abstract listConversations(credentialId: number): Promise<ConversationEntity[]>;
  public abstract deleteConversation(conversationCode: string): Promise<void>;
